...
def main():
    ...
    parser.add_argument('resume', choices = ['resume','new'], help = 'Start new training or resume previous')
    ...
    #Epochs 500
    history = train_model.fit([x_gyro, x_acc, y_delta_p, y_delta_q], epochs= 500, 
    batch_size=32, verbose=1, callbacks=[model_checkpoint, tensorboard], validation_split=0.1)
    ...
    'SingleAttention': SingleAttention,
    'MultiAttention': MultiAttention,
    'TransformerEncoder': TransformerEncoder}, compile=False)
